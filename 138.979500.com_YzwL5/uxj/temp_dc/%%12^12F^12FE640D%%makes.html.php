...
</span> — <span class="gameName" id="gameName"></span><span class="result">&nbsp;今日输赢：<span id="bresult" class='synow'>0.0</span></span></div>
...
</span>期<span class="cdContainer panstatus"  s='<?php echo $this->_tpl_vars['panstatus']; ?>
...
'>&nbsp;&nbsp;<?php if ($this->_tpl_vars['panstatus'] == 1): ?>距离封盘:<?php else: ?>距离开盘:<?php endif; ?>
    <span class="color_lv bold"><span id="cdClose" class="time0"><?php echo $this->_tpl_vars['pantime']; ?>
     ...
     &nbsp;&nbsp;距离开奖：<span class="color_lv bold kjstatus"><span id="cdDraw" class="kjtime" timek='<?php echo $this->_tpl_vars['kjtime']; ?>
